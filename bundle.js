...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrollreveal = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var productEvents = __webpack_require__(11);

	// const cartEvents = require('../scripts/cart/cart_events.js');
	var stripeEvents = __webpack_require__(38);

	var signInPrompt = __webpack_require__(39);

	// animations for stuff
	var gearScroll = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(signUpData) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateItem = function onUpdateItem(event) {
	  ...
	  api.updateItem(itemId, data).then(ui.updateItemSuccess).then(function () {
	    onGetItems();
	  }).catch(ui.updateItemFailure);
	};

	var onDeleteItem = function onDeleteItem() {
	  var id = event.target.getAttribute('data-id');
	  console.log('DELETED', id);
	  api.deleteItem(id).then(ui.deleteItemSuccess).then(function () {
	    onGetItems();
	  }).catch(ui.deleteItemFailure);
	};

	var getPriceTotal = function getPriceTotal() {
	  ...
	  api.getItems().then(function (items) {
	    ...
	    for (var item in items.serialized) {
	      for (var i = 0; i < items.serialized[item].count; i++) {
	        itemList.push(items.serialized[item].product_id);
	      }
	    }
	  }).then(api.getAllProducts).then(function (productList) {
	    ...
	    return total;
	  }).then(ui.getPriceTotalSuccess).catch(console.error);
	};

	var onGetItems = function onGetItems() {
	  console.log('All the items of the cart!');
	  api.getItems().then(ui.getItemsSuccess).then(function () {
	...
	var onAddItem = function onAddItem(event) {
	  event.preventDefault();
	  var countData = getFormFields(event.target);
	  console.log('this is the event', event);
	  console.log('ADD ME!', 'countData', countData);
	  api.addItem(countData).then(ui.addItemSuccess).then(function (data) {
	    onGetItems(data);
	    console.log('after onGetItems');
	  }).catch(ui.addItemFailure);
	};

	var onGetOneProduct = function onGetOneProduct(event) {
	  event.preventDefault();
	  var productId = event.target.getAttribute('data-id');
	  console.log('this is the productId', productId);
	  api.getOneProduct(productId).then(ui.getOneProductSuccess).then(function (data) {
	    console.log('this is data, after getOneProductSuccess', data);
	    $('.product-to-cart').on('submit', onAddItem);
	  }).catch(ui.getOneProductFailure);
	};

	var onGetAllProducts = function onGetAllProducts() {
	  // event.preventDefault();
	  console.log('You have ALL products.');
	  api.getAllProducts().then(ui.getAllProductsSuccess).then(function () {
	    $('.prod-desc').on('click', onGetOneProduct);
	  }).catch(ui.getAllProductsFailure);
	};

	var onGetOrderHx = function onGetOrderHx(event) {
	  event.preventDefault();
	  // console.log('These are my orders!');
	  api.getOrderHx().then(ui.getOrderHxSuccess).catch(ui.getOrderHxFailure);
	};
	...
	var onCreateOrderHx = function onCreateOrderHx() {
	  ...
	  api.createOrderHx(data).then(ui.createOrderHxSuccess).catch(ui.createOrderHxFailure);
	  // api.getItems()
	  // .then(function(data){
	  //   let order = {};
	...
	module.exports = {
	  addCartHandlers: addCartHandlers,
	  onGetAllProducts: onGetAllProducts,
	  onCreateOrderHx: onCreateOrderHx
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getOneProduct = function getOneProduct(productId) {
	  return $.ajax({
	...
	var updateItem = function updateItem(itemId, data) {
	  return $.ajax({
	...
	var getOrderHx = function getOrderHx(data) {
	  return $.ajax({
	...
	var createOrderHx = function createOrderHx(data) {
	  return $.ajax({
	    url: config.host + '/orders',
	    method: 'POST',
	    data: data,
	...
	module.exports = {
	  ...
	  getOrderHx: getOrderHx,
	  createOrderHx: createOrderHx
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var showAllProductsTemplate = __webpack_require__(14);

	var showOneProductTemplate = __webpack_require__(34);
	var cartTemplate = __webpack_require__(35);
	var orderHxTemplate = __webpack_require__(36);
	var sr = __webpack_require__(37);

	var api = __webpack_require__(12);

	var StripeCheckoutSuccess = function StripeCheckoutSuccess() {
	  console.log('You\'ve successfully placed your order.');
	};

	var getAllProductsSuccess = function getAllProductsSuccess(data) {
	...
	var getAllProductsFailure = function getAllProductsFailure() {
	  console.log('FAIL to get all Products!');
	};

	var getOneProductSuccess = function getOneProductSuccess(data) {
	...
	var getOneProductFailure = function getOneProductFailure() {
	  console.log('FAIL to get ONE Product!');
	};

	var addItemSuccess = function addItemSuccess(data) {
	...
	var getItemsFailure = function getItemsFailure(error) {
	  console.log('FAIL!, this is the error', error);
	};

	var deleteItemSuccess = function deleteItemSuccess(data) {
	  console.log('deleted', data);
	};

	var deleteItemFailure = function deleteItemFailure(error) {
	  console.log('FAIL!, this is the delete error', error);
	};

	var updateItemSuccess = function updateItemSuccess(data) {
	  console.log('Item quantity updated successfully.', data);
	};

	var updateItemFailure = function updateItemFailure(error) {
	  console.log('FAIL!, this is the update error', error);
	};

	var getPriceTotalSuccess = function getPriceTotalSuccess(data) {
	...
	var getPriceTotalFailure = function getPriceTotalFailure(error) {
	...
	var clearCart = function clearCart() {
	  ...
	  api.getItems().then(function (data) {
	    ...
	    //data.serialized[0]
	    for (var item in data.serialized) {
	...
	var createOrderHxSuccess = function createOrderHxSuccess(data) {
	...
	var createOrderHxFailure = function createOrderHxFailure(error) {
	  console.log('FAIL!, this is the NEW order hx error:', error);
	};

	var getOrderHxSuccess = function getOrderHxSuccess(data) {
	  console.log('This is your order hx:', data);
	  $('#order-history').html(orderHxTemplate(data));
	};

	var getOrderHxFailure = function getOrderHxFailure(error) {
	...
	module.exports = {
	  ...
	  getAllProductsFailure: getAllProductsFailure,
	  getOneProductSuccess: getOneProductSuccess,
	  getOneProductFailure: getOneProductFailure,
	  addItemSuccess: addItemSuccess,
	  addItemFailure: addItemFailure,
	  ...
	  getPriceTotalSuccess: getPriceTotalSuccess,
	  getPriceTotalFailure: getPriceTotalFailure,
	  createOrderHxSuccess: createOrderHxSuccess,
	  createOrderHxFailure: createOrderHxFailure,
	  getOrderHxSuccess: getOrderHxSuccess,
	  getOrderHxFailure: getOrderHxFailure,
	  clearCart: clearCart
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.products : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"product-module-handlebars prod-desc\" data-id="
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.name : stack1), depth0))
	    + ">\n      </div>\n      <div class=\"form-group\">\n        <input type=\"hidden\" name=\"item[description]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\">\n      </div>\n      <div class=\"form-group\">\n        <input type=\"hidden\" name=\"item[price]\" value="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.price : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <div class=\"row\" data-id="
	    ...
	    + ">\n      <div class=\"col-xs-2 cart-item-name\">\n        <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n      </div>\n      <div class=\"col-xs-1 cart-item-price\">\n        <p>$"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
	    + "</p>\n      </div>\n      <div class=\"col-xs-3 cart-item-quant\">\n        <form class=\"update-form\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n          <div class=\"form-group\">\n            <input class=\"quantity\" type=\"number\" min=1 step=1 value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.count : stack1), depth0))
	    + " name=\"item[count]\">\n            <button type=\"submit\" class=\"update-cart-item\">Update Quantity</button>\n          </div>\n        </form>\n      </div>\n      <div class=\"col-xs-2\">\n        <button type=\"button\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " class=\"delete-cart-item\">Delete</button>\n        <br>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.serialized : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"order-history-wrapper\">\n    <p class=\"order-history-id col-xs-4\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "</p>\n    <div class=\"order-history-items col-xs-4\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.items : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </div>\n    <p class=\"order-history-date col-xs-4\">Order date: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
	    + "</p>\n  </div>\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports) {
	...
	var revealWatch = function revealWatch(element1, element2) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var productUi = __webpack_require__(13);
	var productEvents = __webpack_require__(11);
	var store = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"prompt-body\">\n  <p class=\"prompt-text\"> Welcome! <br><br><br>It's Time to Sign In</p>\n  <img src=\"#\" alt=\"arrow\"/>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gearScroll = function gearScroll() {
	...
	module.exports = {
	    gearScroll: gearScroll,
	    browser_transform: browser_transform
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
